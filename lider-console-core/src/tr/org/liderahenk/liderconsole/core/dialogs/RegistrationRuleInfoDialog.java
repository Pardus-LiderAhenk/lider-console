 ...
 *
 */
public class RegistrationRuleInfoDialog extends DefaultLiderDialog {

	private static final Logger logger = LoggerFactory.getLogger(RegistrationRuleInfoDialog.class);
	 ...
	 */
	public RegistrationRuleInfoDialog(Shell parentShell, Agent selectedAgent) {
		super(parentShell);
		this.selectedAgent = selectedAgent;
	}

	public RegistrationRuleInfoDialog(Shell parentShell, String dn) {
		super(parentShell);
